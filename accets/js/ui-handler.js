...
function initTheme() {
    ...
    themeSwitcher.addEventListener('click', () => {
        ...
        updateBackgroundColor(); // Notify the 3D scene to change background color
    });
}
...
function showSettingsModal() {
    ...
    colorSettingsDiv.innerHTML = ''; // Clear previous fields
    const faces = [
    ...
    faces.forEach(face => {
        ...
        colorInput.addEventListener('change', updateCubeColors); // Notify the cube to update
